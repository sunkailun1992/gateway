...
public class DateUtil {
     ...
     * @author sunkailun
     * @DateTime 2019/11/4  9:46 上午
     * @email 376253703@qq.com
     * @phone 13777579028
     */
    public static String currentMonth() {
        return DateUtil.dateToString(new Date(), "yyyy-MM");
    }
    ...
    public static String lastMonth() {
        return DateUtil.dateToString(DateUtil.addMonth(new Date(), -1), "yyyy-MM");
    }
    ...
    public static Date lastMonthDate() {
        return DateUtil.addMonth(new Date(), -1);
    }
     ...
     * @return
     */
    public static List<String> getCurrentMonth(String date) {
        //d:当前月份
        int d = 0;
        if (new Integer(date.substring(5, 6)) == 1) {
            d = new Integer(date.substring(5, 7));
        } else {
            d = new Integer(date.substring(6, 7));
        }
